        ...
        <transition-group name="vacancy-list" class="row">
            ...
            <span class="new">3</span>
                ...
                <div v-if="!editing">
                    ...
                    <span @click="editEnter(vacancy)">Редактировать</span>
                </div>
                <div v-if="editing">
                    <input v-model="vacancy.title" type="text" placeholder="Введите название вакансии">
                    <button>OK</button>
                    <button @click="editCancel(vacancy)">Отмена</button>
                </div>  
                    ...
                    <p>{{ vacancy.description }}</p>
                        ...
                        <button class="btn but_or">Редактировать</button>
